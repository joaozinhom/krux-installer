...
parser.add_argument(
    "-V", "--app-version", help="The version of your application o x.y.z form"
)
...
parser.add_argument(
    ...
    "--asset",
    action="append",
    help="The name of asset and the path in form of name:path",
)
parser.add_argument(
    "-O", "--output", help="The folder where the the NSIS script will be put"
)
